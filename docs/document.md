...
**Loom** 版本则采用更高版本的 **Minecraft**，也即 `v1.21.94` 的版本的国际基岩版使用。

这意味着，使用 **Bedrock** 版本需要使用 `v1.21.2` 的国际基岩版，而 **Loom** 则是 `v1.21.94` 的基岩版。<br/>
...
在拥有正版的国际基岩版后，请确保您已经下载并安装到电脑，然后前往下述链接下载第三方基岩版我的世界启动器。
...
如果您使用的是 **Loom** 版本的 **赞颂者**，请安装 `v1.21.94 (v1.21.94.1)` 的我的世界。

![image](./images/bedrock_launcher_config_4.png)

本教程以 `v1.21.94` 的为例，在安装完国际版基岩版后，您将看见以下界面，然后您需要点击“开始游戏”。
...
由于本教程以 `v1.21.94` 的国际版我的世界为例，因此我们在此展示 **Loom** 版本的用法。<br/>
点击 `Assets` 使得其展开。<br/>
...
9. 您确认您因使用本项目及相关服务所造成的损失与寄叶服务提供方是无关的，您应当自行承担全部可能的责任
