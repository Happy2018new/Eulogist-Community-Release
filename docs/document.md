...
**Loom** 版本则采用更高版本的 **Minecraft**，也即 `v1.21.101` 的版本的国际基岩版使用。

这意味着，使用 **Bedrock** 版本需要使用 `v1.21.2` 的国际基岩版，而 **Loom** 则是 `v1.21.101` 的基岩版。<br/>
...
如果您使用的是 **Loom** 版本的 **赞颂者**，请安装 `v1.21.101 (v1.21.101.1)` 的我的世界。
